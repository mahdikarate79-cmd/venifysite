export const translations = {
  en: {
    ...
    games: 'Games',
    chat: 'Chat',
    chatOnTelegram: 'Chatting on Telegram',
    profile: 'Profile',
    gameRules: 'How to Play',
    close: 'Close',
    selectLanguage: 'Language',
    helpTitle: 'Game Guide',
    helpSubtitle: 'Tap a game to learn how to play',
  ...
  ru: {
    ...
    games: 'Игры',
    chat: 'Чат',
    chatOnTelegram: 'Общение в Telegram',
    profile: 'Профиль',
    gameRules: 'Как играть',
    close: 'Закрыть',
    selectLanguage: 'Язык',
    helpTitle: 'Руководство по играм',
    helpSubtitle: 'Нажмите на игру, чтобы узнать правила',
    comingSoon: 'Скоро',
  ...
  ar: {
    ...
    games: 'ألعاب',
    chat: 'دردشة',
    chatOnTelegram: 'الدردشة على تيليجرام',
    profile: 'الملف',
    gameRules: 'كيفية اللعب',
    close: 'إغلاق',
    selectLanguage: 'اللغة',
    helpTitle: 'دليل الألعاب',
    helpSubtitle: 'اضغط على لعبة لمعرفة كيفية اللعب',
    comingSoon: 'قريباً',
  ...
  fa: {
    ...
    games: 'بازی‌ها',
    chat: 'چت',
    chatOnTelegram: 'چت در تلگرام',
    profile: 'پروفایل',
    gameRules: 'نحوه بازی',
    close: 'بستن',
    selectLanguage: 'زبان',
    helpTitle: 'راهنمای بازی‌ها',
    helpSubtitle: 'روی هر بازی بزنید تا نحوه بازی را ببینید',
    comingSoon: 'به زودی',
...
export type GameKey = keyof typeof translations.en.gamesList;
